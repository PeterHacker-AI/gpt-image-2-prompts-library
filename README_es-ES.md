# Awesome GPT Image 2 Prompts en Español
...
- [Explorar la biblioteca completa](https://aigptimage.com/es/image-prompts)
- [Open GPT Image 2 on aigptimage.com](https://aigptimage.com/es)
- [Ver precios y suscripciones](https://aigptimage.com/es/pricing)
- [Leer documentación de API](https://aigptimage.com/es/docs)
- [Crear una clave API](https://aigptimage.com/es/settings/apikeys) (requiere inicio de sesión)
...
2. Open the matching prompt page on [aigptimage.com](https://aigptimage.com/es/image-prompts) to browse the full context.
3. Use the prompt in the web app, or upgrade on [the pricing page](https://aigptimage.com/es/pricing) if you need more credits or subscription access.
4. If you are building programmatically, start from [the API docs](https://aigptimage.com/es/docs) and then create keys at [API Keys](https://aigptimage.com/es/settings/apikeys) after sign-in.

## Categorías

| Category | Slug | Entries |
| --- | --- | ---: |
| [Illustration & Art](https://aigptimage.com/es/image-prompts/illustration-art) | `illustration-art` | 306 |
| [Infographics & Education](https://aigptimage.com/es/image-prompts/infographics-education) | `infographics-education` | 127 |
| [UI & Social Mockup](https://aigptimage.com/es/image-prompts/ui-social-mockup) | `ui-social-mockup` | 104 |
| [Portrait & Photography](https://aigptimage.com/es/image-prompts/portrait-photography) | `portrait-photography` | 103 |
| [E-commerce & Product](https://aigptimage.com/es/image-prompts/ecommerce-product) | `ecommerce-product` | 89 |
| [Ads & Marketing](https://aigptimage.com/es/image-prompts/ads-marketing) | `ads-marketing` | 89 |
| [Creative Experiments](https://aigptimage.com/es/image-prompts/creative-experiments) | `creative-experiments` | 64 |
| [Poster & Typography](https://aigptimage.com/es/image-prompts/poster-typography) | `poster-typography` | 31 |
| [Fashion & Beauty](https://aigptimage.com/es/image-prompts/fashion-beauty) | `fashion-beauty` | 28 |
| [Character Design](https://aigptimage.com/es/image-prompts/character-design) | `character-design` | 21 |
| [Food & Drink](https://aigptimage.com/es/image-prompts/food-drink) | `food-drink` | 15 |
| [Video, Collage & Storyboard](https://aigptimage.com/es/image-prompts/video-collage-storyboard) | `video-collage-storyboard` | 14 |
| [Diagrams & Reference](https://aigptimage.com/es/image-prompts/diagram-reference) | `diagram-reference` | 10 |
| [Game & Entertainment](https://aigptimage.com/es/image-prompts/game-entertainment) | `game-entertainment` | 9 |
| [Image Editing & Restoration](https://aigptimage.com/es/image-prompts/image-editing) | `image-editing` | 1 |
| [Architecture & Interior](https://aigptimage.com/es/image-prompts/architecture-interior) | `architecture-interior` | 1 |
...
- Use on AIGPTIMAGE: [Open prompt page](https://aigptimage.com/es/image-prompts/p/luxury-glam-beauty-portrait)
...
- Use on AIGPTIMAGE: [Open prompt page](https://aigptimage.com/es/image-prompts/p/anime-character-brand-identity-merch-board)
...
- Use on AIGPTIMAGE: [Open prompt page](https://aigptimage.com/es/image-prompts/p/style-to-ui-design-system)
...
| --- | --- | --- |
| [E-commerce Main Image - Luxury Amber Perfume Ad](https://aigptimage.com/es/image-prompts/p/e-commerce-main-image-luxury-amber-perfume-ad) | E-commerce & Product | A GPT Image 2 e-commerce prompt case for E-commerce Main Image - Luxury Amber P… |
| [E-commerce Main Image - Skincare Product Studio Shot](https://aigptimage.com/es/image-prompts/p/e-commerce-main-image-skincare-product-studio-shot) | E-commerce & Product | A GPT Image 2 e-commerce prompt case for E-commerce Main Image - Skincare Produ… |
| [E-commerce Main Image - Tropical Citrus Soda Ad Poster](https://aigptimage.com/es/image-prompts/p/e-commerce-main-image-tropical-citrus-soda-ad-poster) | E-commerce & Product | A GPT Image 2 e-commerce prompt case for E-commerce Main Image - Tropical Citru… |
| [E-commerce Main Image - Industrial Design Presentation Sheet](https://aigptimage.com/es/image-prompts/p/e-commerce-main-image-industrial-design-presentation-sheet) | E-commerce & Product | A GPT Image 2 e-commerce prompt case for E-commerce Main Image - Industrial Des… |
| [4-Panel Japanese Digital Ad Banner Grid](https://aigptimage.com/es/image-prompts/p/4-panel-japanese-digital-ad-banner-grid) | Ads & Marketing | A GPT Image 2 ad creative prompt case for 4-Panel Japanese Digital Ad Banner Gr… |
| [Anime Character Brand Identity & Merch Board](https://aigptimage.com/es/image-prompts/p/anime-character-brand-identity-merch-board) | Ads & Marketing | A GPT Image 2 ad creative prompt case for Anime Character Brand Identity & Merc… |
| [Dark Mode Marketing Case Study UI](https://aigptimage.com/es/image-prompts/p/dark-mode-marketing-case-study-ui) | Ads & Marketing | A GPT Image 2 ad creative prompt case for Dark Mode Marketing Case Study UI. |
| [18-Panel Mascot Brand Identity Document](https://aigptimage.com/es/image-prompts/p/18-panel-mascot-brand-identity-document) | Ads & Marketing | A GPT Image 2 ad creative prompt case for 18-Panel Mascot Brand Identity Docume… |
| [Convenience Store Neon Portrait](https://aigptimage.com/es/image-prompts/p/convenience-store-neon-portrait) | Portrait & Photography | A GPT Image 2 portrait & photography prompt case for Convenience Store Neon Por… |
| [Cinematic Minimal Portrait](https://aigptimage.com/es/image-prompts/p/cinematic-minimal-portrait) | Portrait & Photography | A GPT Image 2 portrait & photography prompt case for Cinematic Minimal Portrait. |
| [Japanese Onsen Ryokan Portrait](https://aigptimage.com/es/image-prompts/p/japanese-onsen-ryokan-portrait) | Portrait & Photography | A GPT Image 2 portrait & photography prompt case for Japanese Onsen Ryokan Port… |
| [35mm Flash Editorial Portrait](https://aigptimage.com/es/image-prompts/p/35mm-flash-editorial-portrait) | Portrait & Photography | A GPT Image 2 portrait & photography prompt case for 35mm Flash Editorial Portr… |
| [Rice Grain Micro Typography](https://aigptimage.com/es/image-prompts/p/rice-grain-micro-typography) | Poster & Typography | Use this GPT Image 2 prompt case to create Rice Grain Micro Typography with a r… |
| [Where Is [Your Name] Crowd Search Poster](https://aigptimage.com/es/image-prompts/p/where-is-your-name-crowd-search-poster) | Poster & Typography | Use this GPT Image 2 prompt case to create Where Is [Your Name] Crowd Search Po… |
| [1980s Propaganda Poster](https://aigptimage.com/es/image-prompts/p/1980s-propaganda-poster) | Poster & Typography | Use this GPT Image 2 prompt case to create 1980s Propaganda Poster with a reusa… |
| [Celebrity Car Endorsement Poster](https://aigptimage.com/es/image-prompts/p/celebrity-car-endorsement-poster) | Poster & Typography | Use this GPT Image 2 prompt case to create Celebrity Car Endorsement Poster wit… |
| [One-Prompt UI Design Generation](https://aigptimage.com/es/image-prompts/p/one-prompt-ui-design-generation) | UI & Social Mockup | A GPT Image 2 ui & social media mockup prompt case for One-Prompt UI Design Gen… |
| [Amateur iPhone Keynote Snapshot](https://aigptimage.com/es/image-prompts/p/amateur-iphone-keynote-snapshot) | UI & Social Mockup | A GPT Image 2 ui & social media mockup prompt case for Amateur iPhone Keynote S… |
| [Handwritten Notebook Photo](https://aigptimage.com/es/image-prompts/p/handwritten-notebook-photo) | UI & Social Mockup | A GPT Image 2 ui & social media mockup prompt case for Handwritten Notebook Pho… |
| [Song Dynasty Social Media Feed](https://aigptimage.com/es/image-prompts/p/song-dynasty-social-media-feed) | UI & Social Mockup | A GPT Image 2 ui & social media mockup prompt case for Song Dynasty Social Medi… |
| [Key Character Relationship Map](https://aigptimage.com/es/image-prompts/p/key-character-relationship-map) | Infographics & Education | Use this GPT Image 2 prompt case to create Key Character Relationship Map with… |
| [Museum Catalog-Style Chinese Disassembly Infographic](https://aigptimage.com/es/image-prompts/p/museum-catalog-style-chinese-disassembly-infographic) | Infographics & Education | Use this GPT Image 2 prompt case to create Museum Catalog-Style Chinese Disasse… |
| [World Time Analog Clock Wall](https://aigptimage.com/es/image-prompts/p/world-time-analog-clock-wall) | Infographics & Education | Use this GPT Image 2 prompt case to create World Time Analog Clock Wall with a… |
| [Encyclopedia-Style Knowledge Card](https://aigptimage.com/es/image-prompts/p/encyclopedia-style-knowledge-card) | Infographics & Education | Use this GPT Image 2 prompt case to create Encyclopedia-Style Knowledge Card wi… |

## Rutas del producto

- Explorar la biblioteca completa: [aigptimage.com/image-prompts](https://aigptimage.com/es/image-prompts)
- Open prompt page: `https://aigptimage.com/es/image-prompts/p/<slug>`
- Categorías: `https://aigptimage.com/es/image-prompts/<category-slug>`
- Ver precios y suscripciones: [aigptimage.com/pricing](https://aigptimage.com/es/pricing)
- Leer documentación de API: [aigptimage.com/docs](https://aigptimage.com/es/docs)
- Crear una clave API: [aigptimage.com/settings/apikeys](https://aigptimage.com/es/settings/apikeys)
