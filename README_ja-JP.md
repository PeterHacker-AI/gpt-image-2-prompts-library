# Awesome GPT Image 2 Prompts 日本語版
...
- [完全なプロンプトライブラリを見る](https://aigptimage.com/ja/image-prompts)
- [Open GPT Image 2 on aigptimage.com](https://aigptimage.com/ja)
- [料金とサブスクリプションを見る](https://aigptimage.com/ja/pricing)
- [API ドキュメントを読む](https://aigptimage.com/ja/docs)
- [API キーを作成](https://aigptimage.com/ja/settings/apikeys) (ログインが必要)
...
2. Open the matching prompt page on [aigptimage.com](https://aigptimage.com/ja/image-prompts) to browse the full context.
3. Use the prompt in the web app, or upgrade on [the pricing page](https://aigptimage.com/ja/pricing) if you need more credits or subscription access.
4. If you are building programmatically, start from [the API docs](https://aigptimage.com/ja/docs) and then create keys at [API Keys](https://aigptimage.com/ja/settings/apikeys) after sign-in.

## カテゴリ

| Category | Slug | Entries |
| --- | --- | ---: |
| [Illustration & Art](https://aigptimage.com/ja/image-prompts/illustration-art) | `illustration-art` | 306 |
| [Infographics & Education](https://aigptimage.com/ja/image-prompts/infographics-education) | `infographics-education` | 127 |
| [UI & Social Mockup](https://aigptimage.com/ja/image-prompts/ui-social-mockup) | `ui-social-mockup` | 104 |
| [Portrait & Photography](https://aigptimage.com/ja/image-prompts/portrait-photography) | `portrait-photography` | 103 |
| [E-commerce & Product](https://aigptimage.com/ja/image-prompts/ecommerce-product) | `ecommerce-product` | 89 |
| [Ads & Marketing](https://aigptimage.com/ja/image-prompts/ads-marketing) | `ads-marketing` | 89 |
| [Creative Experiments](https://aigptimage.com/ja/image-prompts/creative-experiments) | `creative-experiments` | 64 |
| [Poster & Typography](https://aigptimage.com/ja/image-prompts/poster-typography) | `poster-typography` | 31 |
| [Fashion & Beauty](https://aigptimage.com/ja/image-prompts/fashion-beauty) | `fashion-beauty` | 28 |
| [Character Design](https://aigptimage.com/ja/image-prompts/character-design) | `character-design` | 21 |
| [Food & Drink](https://aigptimage.com/ja/image-prompts/food-drink) | `food-drink` | 15 |
| [Video, Collage & Storyboard](https://aigptimage.com/ja/image-prompts/video-collage-storyboard) | `video-collage-storyboard` | 14 |
| [Diagrams & Reference](https://aigptimage.com/ja/image-prompts/diagram-reference) | `diagram-reference` | 10 |
| [Game & Entertainment](https://aigptimage.com/ja/image-prompts/game-entertainment) | `game-entertainment` | 9 |
| [Image Editing & Restoration](https://aigptimage.com/ja/image-prompts/image-editing) | `image-editing` | 1 |
| [Architecture & Interior](https://aigptimage.com/ja/image-prompts/architecture-interior) | `architecture-interior` | 1 |
...
- カテゴリ: [E-commerce & Product](https://aigptimage.com/ja/image-prompts/ecommerce-product), [Ads & Marketing](https://aigptimage.com/ja/image-prompts/ads-marketing)
- Creator: [Polanco_IA](https://x.com/Polanco_IA)
- Source: [Source post](https://x.com/Polanco_IA/status/2047689647967609037)
- Use on AIGPTIMAGE: [Open prompt page](https://aigptimage.com/ja/image-prompts/p/e-commerce-main-image-luxury-amber-perfume-ad)
...
- カテゴリ: [Illustration & Art](https://aigptimage.com/ja/image-prompts/illustration-art), [Infographics & Education](https://aigptimage.com/ja/image-prompts/infographics-education)
- Creator: [Panda20230902](https://x.com/Panda20230902)
- Source: [Source post](https://x.com/Panda20230902/status/2045396918965285111)
- Use on AIGPTIMAGE: [Open prompt page](https://aigptimage.com/ja/image-prompts/p/chengdu-food-map-illustration)
...
- Use on AIGPTIMAGE: [Open prompt page](https://aigptimage.com/ja/image-prompts/p/science-encyclopedia-infographic)
...
- カテゴリ: [Portrait & Photography](https://aigptimage.com/ja/image-prompts/portrait-photography)
- Creator: [patrickassale](https://x.com/patrickassale)
- Source: [Source post](https://x.com/patrickassale/status/2044581766309060765)
- Use on AIGPTIMAGE: [Open prompt page](https://aigptimage.com/ja/image-prompts/p/luxury-glam-beauty-portrait)
...
- カテゴリ: [Ads & Marketing](https://aigptimage.com/ja/image-prompts/ads-marketing), [E-commerce & Product](https://aigptimage.com/ja/image-prompts/ecommerce-product), [Illustration & Art](https://aigptimage.com/ja/image-prompts/illustration-art)
- Creator: [chi_vc_](https://x.com/chi_vc_)
- Source: [Source post](https://x.com/chi_vc_/status/2046061073720369228)
- Use on AIGPTIMAGE: [Open prompt page](https://aigptimage.com/ja/image-prompts/p/anime-character-brand-identity-merch-board)
...
- Use on AIGPTIMAGE: [Open prompt page](https://aigptimage.com/ja/image-prompts/p/dark-mode-marketing-case-study-ui)
...
- カテゴリ: [UI & Social Mockup](https://aigptimage.com/ja/image-prompts/ui-social-mockup)
- Creator: [stark_nico99](https://x.com/stark_nico99)
- Source: [Source post](https://x.com/stark_nico99/status/2045836554451706125)
- Use on AIGPTIMAGE: [Open prompt page](https://aigptimage.com/ja/image-prompts/p/style-to-ui-design-system)
...
- Use on AIGPTIMAGE: [Open prompt page](https://aigptimage.com/ja/image-prompts/p/museum-style-hanfu-breakdown-infographic)
...
- Use on AIGPTIMAGE: [Open prompt page](https://aigptimage.com/ja/image-prompts/p/tropical-parrot-pixel-mosaic)
...
- カテゴリ: [Character Design](https://aigptimage.com/ja/image-prompts/character-design), [Illustration & Art](https://aigptimage.com/ja/image-prompts/illustration-art)
- Creator: [iamrednightS](https://x.com/iamrednightS)
- Source: [Source post](https://x.com/iamrednightS/status/2045075682837836265)
- Use on AIGPTIMAGE: [Open prompt page](https://aigptimage.com/ja/image-prompts/p/persona5-character-reference-card)
...
| --- | --- | --- |
| [E-commerce Main Image - Luxury Amber Perfume Ad](https://aigptimage.com/ja/image-prompts/p/e-commerce-main-image-luxury-amber-perfume-ad) | E-commerce & Product | A GPT Image 2 e-commerce prompt case for E-commerce Main Image - Luxury Amber P… |
| [E-commerce Main Image - Skincare Product Studio Shot](https://aigptimage.com/ja/image-prompts/p/e-commerce-main-image-skincare-product-studio-shot) | E-commerce & Product | A GPT Image 2 e-commerce prompt case for E-commerce Main Image - Skincare Produ… |
| [E-commerce Main Image - Tropical Citrus Soda Ad Poster](https://aigptimage.com/ja/image-prompts/p/e-commerce-main-image-tropical-citrus-soda-ad-poster) | E-commerce & Product | A GPT Image 2 e-commerce prompt case for E-commerce Main Image - Tropical Citru… |
| [E-commerce Main Image - Industrial Design Presentation Sheet](https://aigptimage.com/ja/image-prompts/p/e-commerce-main-image-industrial-design-presentation-sheet) | E-commerce & Product | A GPT Image 2 e-commerce prompt case for E-commerce Main Image - Industrial Des… |
| [4-Panel Japanese Digital Ad Banner Grid](https://aigptimage.com/ja/image-prompts/p/4-panel-japanese-digital-ad-banner-grid) | Ads & Marketing | A GPT Image 2 ad creative prompt case for 4-Panel Japanese Digital Ad Banner Gr… |
| [Anime Character Brand Identity & Merch Board](https://aigptimage.com/ja/image-prompts/p/anime-character-brand-identity-merch-board) | Ads & Marketing | A GPT Image 2 ad creative prompt case for Anime Character Brand Identity & Merc… |
| [Dark Mode Marketing Case Study UI](https://aigptimage.com/ja/image-prompts/p/dark-mode-marketing-case-study-ui) | Ads & Marketing | A GPT Image 2 ad creative prompt case for Dark Mode Marketing Case Study UI. |
| [18-Panel Mascot Brand Identity Document](https://aigptimage.com/ja/image-prompts/p/18-panel-mascot-brand-identity-document) | Ads & Marketing | A GPT Image 2 ad creative prompt case for 18-Panel Mascot Brand Identity Docume… |
| [Convenience Store Neon Portrait](https://aigptimage.com/ja/image-prompts/p/convenience-store-neon-portrait) | Portrait & Photography | A GPT Image 2 portrait & photography prompt case for Convenience Store Neon Por… |
| [Cinematic Minimal Portrait](https://aigptimage.com/ja/image-prompts/p/cinematic-minimal-portrait) | Portrait & Photography | A GPT Image 2 portrait & photography prompt case for Cinematic Minimal Portrait. |
| [Japanese Onsen Ryokan Portrait](https://aigptimage.com/ja/image-prompts/p/japanese-onsen-ryokan-portrait) | Portrait & Photography | A GPT Image 2 portrait & photography prompt case for Japanese Onsen Ryokan Port… |
| [35mm Flash Editorial Portrait](https://aigptimage.com/ja/image-prompts/p/35mm-flash-editorial-portrait) | Portrait & Photography | A GPT Image 2 portrait & photography prompt case for 35mm Flash Editorial Portr… |
| [Rice Grain Micro Typography](https://aigptimage.com/ja/image-prompts/p/rice-grain-micro-typography) | Poster & Typography | Use this GPT Image 2 prompt case to create Rice Grain Micro Typography with a r… |
| [Where Is [Your Name] Crowd Search Poster](https://aigptimage.com/ja/image-prompts/p/where-is-your-name-crowd-search-poster) | Poster & Typography | Use this GPT Image 2 prompt case to create Where Is [Your Name] Crowd Search Po… |
| [1980s Propaganda Poster](https://aigptimage.com/ja/image-prompts/p/1980s-propaganda-poster) | Poster & Typography | Use this GPT Image 2 prompt case to create 1980s Propaganda Poster with a reusa… |
| [Celebrity Car Endorsement Poster](https://aigptimage.com/ja/image-prompts/p/celebrity-car-endorsement-poster) | Poster & Typography | Use this GPT Image 2 prompt case to create Celebrity Car Endorsement Poster wit… |
| [One-Prompt UI Design Generation](https://aigptimage.com/ja/image-prompts/p/one-prompt-ui-design-generation) | UI & Social Mockup | A GPT Image 2 ui & social media mockup prompt case for One-Prompt UI Design Gen… |
| [Amateur iPhone Keynote Snapshot](https://aigptimage.com/ja/image-prompts/p/amateur-iphone-keynote-snapshot) | UI & Social Mockup | A GPT Image 2 ui & social media mockup prompt case for Amateur iPhone Keynote S… |
| [Handwritten Notebook Photo](https://aigptimage.com/ja/image-prompts/p/handwritten-notebook-photo) | UI & Social Mockup | A GPT Image 2 ui & social media mockup prompt case for Handwritten Notebook Pho… |
| [Song Dynasty Social Media Feed](https://aigptimage.com/ja/image-prompts/p/song-dynasty-social-media-feed) | UI & Social Mockup | A GPT Image 2 ui & social media mockup prompt case for Song Dynasty Social Medi… |
| [Key Character Relationship Map](https://aigptimage.com/ja/image-prompts/p/key-character-relationship-map) | Infographics & Education | Use this GPT Image 2 prompt case to create Key Character Relationship Map with… |
| [Museum Catalog-Style Chinese Disassembly Infographic](https://aigptimage.com/ja/image-prompts/p/museum-catalog-style-chinese-disassembly-infographic) | Infographics & Education | Use this GPT Image 2 prompt case to create Museum Catalog-Style Chinese Disasse… |
| [World Time Analog Clock Wall](https://aigptimage.com/ja/image-prompts/p/world-time-analog-clock-wall) | Infographics & Education | Use this GPT Image 2 prompt case to create World Time Analog Clock Wall with a… |
| [Encyclopedia-Style Knowledge Card](https://aigptimage.com/ja/image-prompts/p/encyclopedia-style-knowledge-card) | Infographics & Education | Use this GPT Image 2 prompt case to create Encyclopedia-Style Knowledge Card wi… |

## 製品リンク

- 完全なプロンプトライブラリを見る: [aigptimage.com/image-prompts](https://aigptimage.com/ja/image-prompts)
- Open prompt page: `https://aigptimage.com/ja/image-prompts/p/<slug>`
- カテゴリ: `https://aigptimage.com/ja/image-prompts/<category-slug>`
- 料金とサブスクリプションを見る: [aigptimage.com/pricing](https://aigptimage.com/ja/pricing)
- API ドキュメントを読む: [aigptimage.com/docs](https://aigptimage.com/ja/docs)
- API キーを作成: [aigptimage.com/settings/apikeys](https://aigptimage.com/ja/settings/apikeys)
